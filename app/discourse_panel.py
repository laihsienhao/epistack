...
def render_discourse_panel(graph: Graph) -> None:
    ...
    if not coverage:
        st.info(
            ...
            "which side actually engages with which sub-question, and where one side "
    ...
    st.markdown(
        "Which side actually engages with which sub-question — derived from `topic:` "
    ...
    if shared:
        ...
        st.caption(
            ...
            "both sides actually address it, even if they draw opposite conclusions "
